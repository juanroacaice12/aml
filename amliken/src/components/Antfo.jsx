...
export default function Main() {
  const handleSendClick = () => {
    // Reemplaza con el correo electrónico al que quieres enviar el mensaje
    window.location.href = 'mailto:contacto@tuempresa.com?subject=Consulta&body=Hola, tengo una consulta.';
  };
        ...
        <div className='w-full max-w-[611px] h-auto bg-[#fff] rounded-[15px] p-6 flex flex-col items-center'>
          <div className='w-full max-w-[469px] flex flex-col gap-[16px] items-center'>
            ...
            <span className="text-[18px] font-normal text-[rgba(51,51,51,0.8)] text-center">
              Puedes comunicarte con nosotros mediante nuestro correo electrónico para simplificar tus necesidades, amliken está listo para ayudarte.
            </span>
          </div>
          <button
